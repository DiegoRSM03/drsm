...
export const About = ({ dictionary }: AboutProps) => {
  const { about } = dictionary.home.landing
  const mergedInnerSections = Object.entries(ABOUT_INNER_SECTIONS).map(
    ([key, value]) => ({
      ...value,
      ...about.innerSections[key],
    })
  )
  ...
  return (
    ...
    >
      <div className={`${WRAPPER_CHILD_STYLES} flex flex-col gap-20 xl:gap-40`}>
        {Object.entries(mergedInnerSections).map(
          ([innerSectionKey, innerSection], index) => {
            ...
            return (
              ...
              >
                ...
                {isFirstInnerSection && (
                  <Link href={about.linkHref} className="w-full xl:hidden">
                ...
                <div className="flex flex-col justify-end">
                  {isFirstInnerSection && (
                    <Link href={about.linkHref} className="hidden xl:block">
